package com.esiran.greenpay.generator;
...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.esiran.greenpay");
        // 全局配置
        GlobalConfig gc = new GlobalConfig();
        String projectPath = System.getProperty("user.dir") + "/greenpay-" + pc.getModuleName();

        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("Militch");
        gc.setOpen(false);
...
//        dsc.setPassword("ruixiao123");
        ...
        */
        ...
        strategy.setSuperEntityClass("com.esiran.greenpay.common.entity.BaseMapperEntity");
